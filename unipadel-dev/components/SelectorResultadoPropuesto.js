...
import { proponerResultadoPartido } from "../api";

const SelectorResultadoPropuesto = ({
  modalVisible,
  setModalVisible,
  partido,
  torneo,
  ...
  const proponerResultado = async () => {
    ...
    const data = await proponerResultadoPartido(request)
      .then(() => {
        onRefresh();
        setModalVisible(!modalVisible);
        Alert.alert(
          "Resultado propuesto!",
          "Se ha propuesto a la pareja rival el resultado del partido",
          [
            {
              text: "¡OK!",
            },
        ...
        <View style={styles.centeredView}>
          <View style={styles.modalView}>
            ...
            <TouchableOpacity
              ...
              onPress={() => proponerResultado()}
            >
              <Text style={styles.textStylePropose}>Proponer resultado</Text>
            </TouchableOpacity>
            <TouchableOpacity
...
export default SelectorResultadoPropuesto;
